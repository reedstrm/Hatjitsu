...
Room.prototype.setRoomTitle = function(data) {
  this.roomTitle = data.roomTitle;
  this.io.sockets.in(this.roomUrl).emit('room title set');
  // console.log('room title set');
}

Room.prototype.setVoteHistory = function(data) {
  this.voteHistory = data.history;
  this.io.sockets.in(this.roomUrl).emit('vote history set');
  // console.log('vote history set');
}
